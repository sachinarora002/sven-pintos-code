...
struct thread
  {
    ...
    int fd;				/* the counter for the entries in the FD table */
    struct list children;		/* list of children for the thread */
    struct child * me;			/* the child structure for communicating to the parent */
...
//structure for the parent children list
struct child 
{
	pid_t pid;
